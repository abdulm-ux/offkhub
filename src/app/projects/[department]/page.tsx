...
export default async function ProjectsDepartmentPage({ params }: { params: { department: string } }) {
  ...
  return (
    <div>
      <div className="font-mono text-xs text-tape uppercase tracking-widest mb-2">Projects / {dept?.name}</div>
